...
$to = "info@castorsolutions.co.ke";														// To Address
$toAlt = "";												// Additional Recipients
$from = "info@castorsolutions.co.ke";													// From Address
...
$template = "Hi,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Castor Solutions";											// Mail Template
...
$smtpHost = "smtp.zoho.com";											// SMTP Host
$smtpPort = "465";											// SMTP Port
$smtpSecure = "ssl";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "info@castorsolutions.co.ke";									// SMTP Username
$smtpPassword = "IamCastor2018**!!";									// SMTP Password
